  ...
  ".next/server/src/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[550], { 521: (e) => {
      ...
      function l(e2) {
        ...
        if (!e2)
          return;
        let [[n2, i2], ...o2] = s(e2), { domain: a2, expires: l2, httponly: d2, maxage: p2, path: h, samesite: g, secure: f, partitioned: v, priority: b } = Object.fromEntries(o2.map(([e3, t3]) => [e3.toLowerCase(), t3]));
        return function(e3) {
          let t3 = {};
          for (let r3 in e3)
            e3[r3] && (t3[r3] = e3[r3]);
      ...
      (() => {
        var i = { 226: function(i2, o2) {
          !function(a2, s2) {
            ...
            ee.VERSION = "1.0.35", ee.BROWSER = W([g, b, p]), ee.CPU = W([m]), ee.DEVICE = W([h, v, f, w, _, x, y, S, C]), ee.ENGINE = ee.OS = W([g, b]), typeof o2 !== u ? (i2.exports && (o2 = i2.exports = ee), o2.UAParser = ee) : r.amdO ? void 0 !== (n = function() {
              return ee;
      ...
      "use strict";
      let n;
      r.r(t), r.d(t, { default: () => tt });
      var i, o, a, s, l, u, c, d, p, h, g, f, v = {};
      async function b() {
        return "_ENTRIES" in globalThis && _ENTRIES.middleware_instrumentation && await _ENTRIES.middleware_instrumentation;
      }
      r.r(v), r.d(v, { middleware: () => e9 });
      let m = null;
      async function w() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let T = { shared: "shared", reactServerComponents: "rsc", serverSideRendering: "ssr", actionBrowser: "action-browser", api: "api", middleware: "middleware", instrument: "instrument", edgeAsset: "edge-asset", appPagesBrowser: "app-pages-browser" };
      function E(e10) {
      ...
      function R(e10) {
        ...
        if (e10)
          for (let [n2, i2] of e10.entries())
            "set-cookie" === n2.toLowerCase() ? (r2.push(...E(i2)), t2[n2] = 1 === r2.length ? r2[0] : r2) : t2[n2] = i2;
        return t2;
      }
      function N(e10) {
        try {
      ...
      class A {
        ...
        waitUntil(e10) {
          if ("external" === this[k].kind)
            return (0, this[k].function)(e10);
      ...
      function q(e10, t2) {
        if (!e10.startsWith("/") || !t2)
          return e10;
        let { pathname: r2, query: n2, hash: i2 } = D(e10);
        return "" + t2 + r2 + n2 + i2;
      }
      function U(e10, t2) {
        if (!e10.startsWith("/") || !t2)
      ...
      function G(e10, t2) {
        return new URL(String(e10).replace($, "localhost"), t2 && String(t2).replace($, "localhost"));
      }
      let H = Symbol("NextURLInternal");
      class z {
        constructor(e10, t2, r2) {
          let n2, i2;
          "object" == typeof t2 && "pathname" in t2 || "string" == typeof t2 ? (n2 = t2, i2 = r2 || {}) : i2 = r2 || t2 || {}, this[H] = { url: G(e10, n2 ?? i2.base), options: i2, basePath: "" }, this.analyze();
        }
        analyze() {
          var e10, t2, r2, n2, i2;
          let o2 = function(e11, t3) {
            ...
            i3 && V(s3.pathname, i3) && (s3.pathname = function(e12, t4) {
              if (!V(e12, t4))
                return e12;
            ...
            if (o3) {
              let e12 = t3.i18nProvider ? t3.i18nProvider.analyze(s3.pathname) : B(s3.pathname, o3.locales);
              s3.locale = e12.detectedLocale, s3.pathname = null != (n3 = e12.pathname) ? n3 : s3.pathname, !e12.detectedLocale && s3.buildId && (e12 = t3.i18nProvider ? t3.i18nProvider.analyze(l2) : B(l2, o3.locales)).detectedLocale && (s3.locale = e12.detectedLocale);
            }
            return s3;
          }(this[H].url.pathname, { nextConfig: this[H].options.nextConfig, parseData: true, i18nProvider: this[H].options.i18nProvider }), a2 = function(e11, t3) {
            let r3;
          ...
          this[H].domainLocale = this[H].options.i18nProvider ? this[H].options.i18nProvider.detectDomainLocale(a2) : function(e11, t3, r3) {
            if (e11)
          ...
          }(null == (t2 = this[H].options.nextConfig) ? void 0 : null == (e10 = t2.i18n) ? void 0 : e10.domains, a2);
          let s2 = (null == (r2 = this[H].domainLocale) ? void 0 : r2.defaultLocale) || (null == (i2 = this[H].options.nextConfig) ? void 0 : null == (n2 = i2.i18n) ? void 0 : n2.defaultLocale);
          this[H].url.pathname = o2.pathname, this[H].defaultLocale = s2, this[H].basePath = o2.basePath ?? "", this[H].buildId = o2.buildId, this[H].locale = o2.locale ?? s2, this[H].trailingSlash = o2.trailingSlash;
        }
        formatPathname() {
          var e10;
          let t2;
          return t2 = function(e11, t3, r2, n2) {
            ...
            return !n2 && (V(i2, "/api") || V(i2, "/" + t3.toLowerCase())) ? e11 : q(e11, "/" + t3);
          }((e10 = { basePath: this[H].basePath, buildId: this[H].buildId, defaultLocale: this[H].options.forceLocale ? void 0 : this[H].defaultLocale, locale: this[H].locale, pathname: this[H].url.pathname, trailingSlash: this[H].trailingSlash }).pathname, e10.locale, e10.buildId ? void 0 : e10.defaultLocale, e10.ignorePrefix), (e10.buildId || !e10.trailingSlash) && (t2 = j(t2)), e10.buildId && (t2 = U(q(t2, "/_next/data/" + e10.buildId), "/" === e10.pathname ? "index.json" : ".json")), t2 = q(t2, e10.basePath), !e10.buildId && e10.trailingSlash ? t2.endsWith("/") ? t2 : U(t2, "/") : j(t2);
        }
        formatSearch() {
        ...
        set locale(e10) {
          var t2, r2;
          if (!this[H].locale || !(null == (r2 = this[H].options.nextConfig) ? void 0 : null == (t2 = r2.i18n) ? void 0 : t2.locales.includes(e10)))
        ...
        clone() {
          return new z(String(this), this[H].options);
        }
      }
      var W = r(555);
      ...
      class K extends Request {
        constructor(e10, t2 = {}) {
          ...
          N(r2), e10 instanceof Request ? super(e10, t2) : super(r2, t2);
          let n2 = new z(r2, { headers: R(this.headers), nextConfig: t2.nextConfig });
          this[F] = { cookies: new W.RequestCookies(this.headers), nextUrl: n2, url: n2.toString() };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
      ...
      let Q = Symbol("internal response"), Y = /* @__PURE__ */ new Set([301, 302, 303, 307, 308]);
      function Z(e10, t2) {
        var r2;
      ...
      class J extends Response {
        constructor(e10, t2 = {}) {
          super(e10, t2);
          let r2 = this.headers, n2 = new Proxy(new W.ResponseCookies(r2), { get(e11, n3, i2) {
            switch (n3) {
              case "delete":
              case "set":
                return (...i3) => {
                  let o2 = Reflect.apply(e11[n3], e11, i3), a2 = new Headers(r2);
                  return o2 instanceof W.ResponseCookies && r2.set("x-middleware-set-cookie", o2.getAll().map((e12) => (0, W.stringifyCookie)(e12)).join(",")), Z(t2, a2), o2;
                };
              default:
                return X.get(e11, n3, i2);
            }
          } });
          this[Q] = { cookies: n2, url: t2.url ? new z(t2.url, { headers: R(r2), nextConfig: t2.nextConfig }) : void 0 };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
        ...
        static redirect(e10, t2) {
          ...
          return i2.set("Location", N(e10)), new J(null, { ...n2, headers: i2, status: r2 });
        }
        static rewrite(e10, t2) {
          let r2 = new Headers(null == t2 ? void 0 : t2.headers);
          return r2.set("x-middleware-rewrite", N(e10)), Z(t2, r2), new J(null, { ...t2, headers: r2 });
        }
        static next(e10) {
          let t2 = new Headers(null == e10 ? void 0 : e10.headers);
          return t2.set("x-middleware-next", "1"), Z(e10, t2), new J(null, { ...e10, headers: t2 });
        }
      }
      function ee(e10, t2) {
      ...
      let et = "Next-Router-Prefetch", er = ["RSC", "Next-Router-State-Tree", et, "Next-HMR-Refresh", "Next-Router-Segment-Prefetch"], en = ["__nextFallback", "__nextLocale", "__nextInferredLocaleFromDefault", "__nextDefaultLocale", "__nextIsNotFound", "_rsc"], ei = ["__nextDataReq"];
      ...
      }(s || (s = {})), (l || (l = {})).startServer = "startServer.startServer", function(e10) {
      ...
      }(c || (c = {})), (d || (d = {})).executeRoute = "Router.executeRoute", (p || (p = {})).runHandler = "Node.runHandler", (h || (h = {})).runHandler = "AppRouteRouteHandlers.runHandler", function(e10) {
      ...
      }, eR = /* @__PURE__ */ new Map(), eN = n.createContextKey("next.rootSpanId"), eI = 0, eM = () => eI++, ek = { set(e10, t2, r2) {
      ...
      class eA {
        ...
        trace(...e10) {
          ...
          return a2.attributes = { "next.span_name": s2, "next.span_type": r2, ...a2.attributes }, ey.with(l2.setValue(eN, c2), () => this.getTracerInstance().startActiveSpan(s2, a2, (e11) => {
            let t3 = "performance" in globalThis && "measure" in performance ? globalThis.performance.now() : void 0, n3 = () => {
              eR.delete(c2), t3 && process.env.NEXT_OTEL_PERFORMANCE_PREFIX && ew.includes(r2 || "") && performance.measure(`${process.env.NEXT_OTEL_PERFORMANCE_PREFIX}:next-${(r2.split(".").pop() || "").replace(/[A-Z]/g, (e12) => "-" + e12.toLowerCase())}`, { start: t3, end: performance.now() });
            };
            u2 && eR.set(c2, new Map(Object.entries(a2.attributes ?? {})));
            try {
              if (o2.length > 1)
                return o2(e11, (t5) => eE(e11, t5));
              let t4 = o2(e11);
              if (e_(t4))
        ...
        setRootSpanAttribute(e10, t2) {
          let r2 = ey.active().getValue(eN), n2 = eR.get(r2);
          n2 && n2.set(e10, t2);
        }
      }
      let eL = (() => {
      ...
      function eq(e10, t2) {
        if ("x-middleware-set-cookie" in e10.headers && "string" == typeof e10.headers["x-middleware-set-cookie"]) {
          ...
          for (let e11 of new W.ResponseCookies(n2).getAll())
            t2.set(e11);
        }
      }
      ...
      let eF = "undefined" != typeof globalThis && globalThis.AsyncLocalStorage;
      class eK {
        ...
        after(e10) {
          if (e_(e10))
            this.waitUntil || eX(), this.waitUntil(e10.catch((e11) => this.reportTaskError(e11)));
          else if ("function" == typeof e10)
            this.addCallback(e10);
          else
            throw Error("`unstable_after()`: Argument must be a promise or a function");
        }
        addCallback(e10) {
          var t2;
          if (this.waitUntil || eX(), !this.onClose)
            throw new eB("unstable_after: Missing `onClose` implementation");
          let r2 = ep.getStore();
          if (!r2)
            throw new eB("Missing workUnitStore in AfterContext.addCallback");
          ...
          let n2 = (t2 = async () => {
            try {
              ...
              this.reportTaskError(e11);
            }
          }, eF ? eF.bind(t2) : eW.bind(t2));
        ...
        reportTaskError(e10) {
          if (console.error("An error occurred in a function passed to `unstable_after()`:", e10), this.onTaskError)
            try {
              null == this.onTaskError || this.onTaskError.call(this, e10);
            } catch (e11) {
              console.error(new eB("`onTaskError` threw while handling an error thrown from an `unstable_after` task", { cause: e11 }));
            }
        }
      }
      function eX() {
      ...
      let eZ = Symbol.for("@next/request-context"), eJ = Symbol.for("@vercel/request-context");
      class e0 extends K {
        constructor(e10) {
      ...
      async function e4(e10) {
        ...
        let a2 = new z(e10.request.url, { headers: e10.request.headers, nextConfig: e10.request.nextConfig });
        ...
        if (!o2)
          for (let e11 of er) {
            ...
            r2 && (c2.set(t3, r2), u2.delete(t3));
          }
        let d2 = new e0({ page: e10.page, input: function(e11, t3) {
        ...
        let p2 = e10.request.waitUntil ?? (null == (t2 = function() {
          let e11 = globalThis, t3 = e11[eZ] ?? e11[eJ];
          return null == t3 ? void 0 : t3.get();
        }()) ? void 0 : t2.waitUntil), h2 = new L({ request: d2, page: e10.page, context: p2 ? { waitUntil: p2 } : void 0 });
        if ((n2 = await e2(d2, () => {
          if ("/middleware" === e10.page || "/src/middleware" === e10.page) {
            var t3, r2;
            let n3, o3;
            let a3 = (null == (r2 = e10.request.nextConfig) ? void 0 : null == (t3 = r2.experimental) ? void 0 : t3.after) ?? false;
            return a3 && (n3 = h2.waitUntil.bind(h2), o3 = new eQ()), eL().trace(f.execute, { spanName: `middleware ${d2.method} ${d2.nextUrl.pathname}`, attributes: { "http.target": d2.nextUrl.pathname, "http.method": d2.method } }, async () => {
              try {
                var t4, r3, l3, u3, c3;
                let p3 = eY(), g3 = (l3 = d2.nextUrl, u3 = void 0, c3 = (e11) => {
                  i2 = e11;
                }, function(e11, t5, r4, n4, i3, o4, a4, s3, l4, u4) {
                  function c4(e12) {
                  ...
                  return { type: "request", phase: e11, implicitTags: i3 ?? [], url: { pathname: n4.pathname, search: n4.search ?? "" }, get headers() {
                    return d3.headers || (d3.headers = function(e12) {
                      let t6 = ea.from(e12);
                      for (let e13 of er)
                        t6.delete(e13.toLowerCase());
                      return ea.seal(t6);
                    }(t5.headers)), d3.headers;
                  }, get cookies() {
                    if (!d3.cookies) {
                      let e12 = new W.RequestCookies(ea.from(t5.headers));
                      eq(t5, e12), d3.cookies = eg.seal(e12);
                    }
                    return d3.cookies;
                  }, set cookies(value) {
                    d3.cookies = value;
                    ...
                    if (!d3.mutableCookies) {
                      let e12 = function(e13, t6) {
                        let r5 = new W.RequestCookies(ea.from(e13));
                        return ev.wrap(r5, t6);
                      }(t5.headers, o4 || (r4 ? c4 : void 0));
                      eq(t5, e12), d3.mutableCookies = e12;
                    }
                    return d3.mutableCookies;
                  }, get userspaceMutableCookies() {
                    if (!d3.userspaceMutableCookies) {
                      let e12 = function(e13) {
                        let t6 = new Proxy(e13, { get(e14, r5, n5) {
                          switch (r5) {
                            case "delete":
                              return function(...r6) {
                                return eb("cookies().delete"), e14.delete(...r6), t6;
                              };
                            case "set":
                              return function(...r6) {
                                return eb("cookies().set"), e14.set(...r6), t6;
                              };
                            default:
                              return X.get(e14, r5, n5);
                          }
                        } });
                        return t6;
                      }(this.mutableCookies);
                    ...
                    return d3.draftMode || (d3.draftMode = new eD(s3, t5, this.cookies, this.mutableCookies)), d3.draftMode;
                  }, renderResumeDataCache: a4 ?? null, devWarmupPrerenderResumeDataCache: null, isHmrRefresh: l4, serverComponentsHmrCache: u4 || globalThis.__serverComponentsHmrCache };
                }("action", d2, void 0, l3, u3, c3, void 0, p3, false, void 0)), f2 = function({ page: e11, fallbackRouteParams: t5, renderOpts: r4, requestEndedState: n4, isPrefetchRequest: i3 }) {
                  var o4;
                  let a4 = { isStaticGeneration: !r4.supportsDynamicResponse && !r4.isDraftMode && !r4.isServerAction, page: e11, fallbackRouteParams: t5, route: (o4 = e11.split("/").reduce((e12, t6, r5, n5) => t6 ? "(" === t6[0] && t6.endsWith(")") || "@" === t6[0] || ("page" === t6 || "route" === t6) && r5 === n5.length - 1 ? e12 : e12 + "/" + t6 : e12, "")).startsWith("/") ? o4 : "/" + o4, incrementalCache: r4.incrementalCache || globalThis.__incrementalCache, cacheLifeProfiles: r4.cacheLifeProfiles, isRevalidate: r4.isRevalidate, isPrerendering: r4.nextExport, fetchCache: r4.fetchCache, isOnDemandRevalidate: r4.isOnDemandRevalidate, isDraftMode: r4.isDraftMode, requestEndedState: n4, isPrefetchRequest: i3, buildId: r4.buildId, reactLoadableManifest: (null == r4 ? void 0 : r4.reactLoadableManifest) || {}, assetPrefix: (null == r4 ? void 0 : r4.assetPrefix) || "", afterContext: function(e12) {
                    var t6;
                    if (!(null == e12 ? void 0 : null == (t6 = e12.experimental) ? void 0 : t6.after))
                      return;
                    let { waitUntil: r5, onClose: n5, onAfterTaskError: i4 } = e12;
                    return new eK({ waitUntil: r5, onClose: n5, onTaskError: i4 });
                  }(r4) };
                  return r4.store = a4, a4;
                }({ page: "/", fallbackRouteParams: null, renderOpts: { cacheLifeProfiles: null == (r3 = e10.request.nextConfig) ? void 0 : null == (t4 = r3.experimental) ? void 0 : t4.cacheLife, experimental: { after: a3, isRoutePPREnabled: false, dynamicIO: false }, buildId: s2 ?? "", supportsDynamicResponse: true, waitUntil: n3, onClose: o3 ? o3.onClose.bind(o3) : void 0 }, requestEndedState: { ended: false }, isPrefetchRequest: d2.headers.has(et) });
                return await ed.run(f2, () => ep.run(g3, e10.handler, d2, h2));
              } finally {
                o3 && setTimeout(() => {
                  o3.dispatchClose();
                }, 0);
        ...
        if (n2 && g2 && !o2) {
          let t3 = new z(g2, { forceLocale: true, headers: e10.request.headers, nextConfig: e10.request.nextConfig });
          t3.host === d2.nextUrl.host && (t3.buildId = s2 || t3.buildId, n2.headers.set("x-middleware-rewrite", String(t3)));
          let r2 = ee(String(t3), String(a2));
          l2 && n2.headers.set("x-nextjs-rewrite", r2);
        }
        let v2 = null == n2 ? void 0 : n2.headers.get("Location");
        if (n2 && v2 && !o2) {
          let t3 = new z(v2, { forceLocale: false, headers: e10.request.headers, nextConfig: e10.request.nextConfig });
          n2 = new Response(n2.body, n2), t3.host === d2.nextUrl.host && (t3.buildId = s2 || t3.buildId, n2.headers.set("Location", String(t3))), l2 && (n2.headers.delete("Location"), n2.headers.set("x-nextjs-redirect", ee(String(t3), String(a2))));
        }
        let b2 = n2 || J.next(), m2 = b2.headers.get("x-middleware-override-headers"), w2 = [];
        if (m2) {
        ...
        return { response: b2, waitUntil: ("internal" === h2[k].kind ? Promise.all(h2[k].promises).then(() => {
      ...
      let e6 = String(process.env.TEMPLE_VALID_PATHS).split(",").map((e10) => e10.trim()), e5 = String(process.env.TEMPLE_EXCLUDED_SUBDOMAINS).split(",").map((e10) => e10.trim());
      function e9(e10) {
        let t2 = e10.nextUrl, r2 = (e10.headers.get("host") || "").split(".")[0], n2 = t2.pathname;
        return r2 && !e5.includes(r2) && e6.includes(n2) ? (t2.pathname = `/temple/${r2}${n2}`, J.rewrite(t2)) : J.next();
      }
      let e7 = { ...v }, e8 = e7.middleware || e7.default, te = "/src/middleware";
      if ("function" != typeof e8)
        throw Error(`The Middleware "${te}" must export a \`middleware\` or a \`default\` function`);
      function tt(e10) {
        return e4({ ...e10, page: te, handler: async (...e11) => {
          try {
            return await e8(...e11);
          } catch (i2) {
            let t2 = e11[0], r2 = new URL(t2.url), n2 = r2.pathname + r2.search;
            throw await _(i2, { path: n2, method: t2.method, headers: Object.fromEntries(t2.headers.entries()) }, { routerKind: "Pages Router", routePath: "/middleware", routeType: "middleware", revalidateReason: void 0 }), i2;
          }
        } });
      }
    } }, (e) => {
