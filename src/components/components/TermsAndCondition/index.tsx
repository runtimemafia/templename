...
const TermsAndConditionPage = () => {
  return (
    <>
      {" "}
      <Container className="md:px-12 px-5 mb-[300px] md:text-left text-justify">
        <Typography className="text-end lg:text-[128px] md:text-[60px] sm:[35px] text-[25px] !font-bold font-adamina">
          Terms & Conditions
        </Typography>
        <div className="font-afacad font-normal tracking-wide text-black ">
          <Typography className=" md:mb-6 mb-3   md:text-[24px] text-[18px]   md:leading-[39px]  leading-[30px] ">
            <span className="block font-semibold">Welcome to bookmypuja</span>
            These terms and conditions outline the rules and regulations for the
            use of BookMyPuja's Website, located at https://bookmypuja.app.{" "}
            <br /> By accessing this website we assume you accept these terms
            and conditions. Do not continue to use bookmypuja.app if you do not
          ...
          <Typography className=" md:mb-6 mb-3   md:text-[24px] text-[18px]   md:leading-[39px]  leading-[30px] ">
            <span className="block font-semibold">Cookies</span> We employ the
            use of cookies. By accessing bookmypuja, you agreed to use cookies
            in agreement with the BookMyPuja's Privacy Policy. <br />
          ...
          <div className=" md:mb-6 mb-3 ">
            <Typography className="  md:text-[24px] text-[18px]   md:leading-[39px]  leading-[30px] ">
              <span className="block font-semibold">License</span>Unless
              otherwise stated, BookMyPuja and/or its licensors own the
              intellectual property rights for all material on bookmypuja. All
              intellectual property rights are reserved. You may access this
              from bookmypuja for your own personal use subjected to
              restrictions set in these terms and conditions.{" "}
            </Typography>
            <div className=" md:text-[24px] text-[18px]   ">
              You must not:
              <ul className="list-disc list-inside indent-4">
                <li>Republish material from bookmypuja </li>
                <li>
                  {" "}
                  Sell, rent or sub-license material from bookmypuja Reproduce,
                  duplicate or copy material from bookmypuja{" "}
                </li>
                <li>Redistribute content from bookmypuja </li>
              </ul>
            </div>
            <Typography className=" md:text-[24px] text-[18px]   md:leading-[39px]  leading-[30px] ">
              ...
              BookMyPuja does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of BookMyPuja,its agents and/or affiliates.
              ...
              laws, BookMyPuja shall not be liable for the Comments or for any
              ...
              on this website. <br />
              BookMyPuja reserves the right to monitor all Comments and to
            ...
            <Typography className=" md:text-[24px] text-[18px]   md:leading-[39px]  leading-[30px] ">
              {" "}
              You hereby grant BookMyPuja a non-exclusive license to use,
              reproduce, edit and authorize others to use, reproduce and edit
              any of your Comments in any and all forms, formats or media.
            </Typography>
          </div>
          <div className=" md:mb-6 mb-3   md:text-[24px] text-[18px]   md:leading-[39px]  leading-[30px] ">
            <span className="block font-semibold">
              Hyperlinking to our Content
            </span>
            following organizations may link to our Website without prior
            written approval:
            <ul className="list-disc list-inside indent-4">
              <li>The Government agencies; </li>
            ...
            visibility of the hyperlink compensates the absence of BookMyPuja;
            ...
            sending an e-mail to BookMyPuja. Please include your name, your
            ...
            No use of BookMyPuja's logo or other artwork will be allowed for
            linking absent a trademark license agreement.
          </div>
          <div className=" md:mb-6 mb-3   md:text-[24px] text-[18px]   md:leading-[39px]  leading-[30px] ">
            <span className="block font-semibold">iFrames</span> Without prior
            approval and written permission, you may not create frames around
            our Webpages that alter in any way the visual presentation or
            appearance of our Website.
          </div>
          <div className=" md:mb-6 mb-3   md:text-[24px] text-[18px]   md:leading-[39px]  leading-[30px] ">
            <span className="block font-semibold">Content Liability </span>We
            ...
            is rising on your Website. No link(s) should appear on any Website
          ...
          <div className=" md:mb-6 mb-3   md:text-[24px] text-[18px]   md:leading-[39px]  leading-[30px] ">
            <span className="block font-semibold">Reservation of Rights</span>{" "}
          ...
          <div className=" md:mb-6 mb-3   md:text-[24px] text-[18px]   md:leading-[39px]  leading-[30px] ">
            <span className="block font-semibold">Disclaimer</span> To the
