    ...
    <>
      <Container className="md:px-12 px-5 mb-[300px] md:text-left text-justify ">
        ...
        <div className="font-afacad font-normal  md:text-[24px] text-[18px]  tracking-wide text-black ">
          <span className="block  md:mb-6 mb-3 ">
          ...
          <span className="block  md:mb-4 mb-2 ">
            {" "}
            ...
            <Link
              target="_blank"
              href={
                "https://www.freeprivacypolicy.com/free-privacy-policy-generator/?ref=bookmypuja.app"
              }
          ...
          <Typography className="font-bold  md:text-[30px] text-[23px] mt-10  md:mb-4 mb-2 ">
            Interpretation and Definitions
          </Typography>
          <div className="md:leading-[39px] leading-[30px]">
            <Typography className="font-bold  md:text-[26px] text-[20px]  md:mb-4 mb-2 ">
              Interpretation
            </Typography>
            <Typography className=" md:text-[24px] text-[18px]   md:mb-4 mb-2 ">
            ...
            <ul className="list-disc list-inside indent-5 marker:font-bold ">
              <li>
              ...
              <li>
                ...
                refers to Zen Technologica, KCRA -28 ,Krishnakananti
                Colony,Puthur ,Palakkad.
              </li>

              <li>
                <span className="font-bold"> Cookies</span> are small files that
                are placed on Your computer, mobile device or any other device
                by a website, containing the details of Your browsing history on
                that website among its many uses.
              </li>

              <li>
                <span className="font-bold">Country</span> refers to: Kerala,
                India
              </li>
              ...
              <li>
                <span className="font-bold">Personal </span>Data is any
              ...
              <li>
                <span className="font-bold"> Service</span> Provider means any
              ...
              <li>
                <span className="font-bold"> Usage </span>Data refers to data
              ...
              <li>
                <span className="font-bold">Website </span>refers to bookmypuja,
                accessible from{" "}
                <Link
            ...
            <Typography className=" md:text-[26px] text-[20px] font-bold  md:mb-4 mb-2 ">
              Types of Data Collected
            </Typography>
            <Typography className=" md:text-[24px] text-[18px]  font-bold  md:mb-4 mb-2 ">
              Personal Data
            </Typography>
            <Typography className=" md:text-[24px] text-[18px]   md:mb-4 mb-2 ">
            ...
            <Typography className=" md:text-[24px] text-[18px]   md:mb-4 mb-2 ">
              ...
              <Link
                href={
                  "https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/?ref=bookmypuja.app#Use_Of_Cookies_And_Tracking"
                }
                target="_blank"
                className="underline hover:text-gray-500"
              >
            ...
            <ul className="list-disc list-outside md:pl-10 pl-5 ">
              <li className="">
                <span className="font-bold">Necessary / Essential Cookies</span>
                <br />
                Type: Session Cookies <br />
                Administered by: Us <br /> Purpose: These Cookies are essential
                to provide You with services available through the Website and
            ...
            <ul className="list-disc list-inside indent-5">
              ...
              <li>
                <span className="font-bold">To contact You:</span> To contact
              ...
              <li>
                <span className="font-bold">For business transfers:</span> We
              ...
              <li>
                <span className="font-bold"> For other purposes: </span>We may
            ...
            <ul className="list-disc list-inside indent-5">
              ...
              <li>
                <span className="font-bold"> With business partners:</span> We
            ...
            <Typography className=" md:text-[30px] text-[23px] font-bold  md:mb-4 mb-2 ">
              Children's Privacy
            </Typography>
            <Typography className=" md:text-[24px] text-[18px]   md:mb-4 mb-2 ">
